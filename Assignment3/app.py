        ...
        while True:
            try:
                ...
                if self.prtcl.IsMessagePartOfProtocol(cipher_text):
                    ...
                    self.sharedSecret.get() # update shared secret
                    self.prtcl.ProcessReceivedProtocolMessage(cipher_text, self.sharedSecret)
